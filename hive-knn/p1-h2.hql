...
from score, averages;
Select score1.*, sqrt(pow(score1.hw-b.hw, 2) + pow(score1.quiz-b.quiz, 2) + pow(score1.final-b.final,2)) as dist from score1, (select hw,quiz,final from score1 where seat=54 AND midterm=110) as b 
